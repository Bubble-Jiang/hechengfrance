            ...
            this.scheduleOnce(function () {
              if (false) {
                ...
                i.default.GameUpdateCtrl && (0 == t.createFruitCount ? (a.default.Instance.createOneFruit(0),
                  ...
                  t.createFruitCount++) : 3 == t.createFruitCount ? (a.default.Instance.createOneFruit(0),
                  t.createFruitCount++) : 4 == t.createFruitCount ? (a.default.Instance.createOneFruit(0),
                  t.createFruitCount++) : 5 == t.createFruitCount ? (a.default.Instance.createOneFruit(1),
                  t.createFruitCount++) : t.createFruitCount > 5 &&
                  (a.default.Instance.createOneFruit(s.default.RandomInteger(Math.max(0,Math.floor(Math.log(t.createFruitCount)/Math.log(2)-4)),Math.floor(Math.log(t.createFruitCount)/Math.log(2)-2))),
                    t.createFruitCount++))
              }
            }, .5))
